...
const optum = {
  ...
  body: (
    <p>
      ...
      role, I worked on updating the website's legal documents and doing a lot
      of my own testing by using impersonating customers and employees in a
      content manager. There was a plethora of things to learn, such as the
      content manager they used to impersonate fake employees and patients to
      ...
      departments in and out of the software team. I was also getting used to
      the workflow of a software engineering role. There were daily standups and
      the team was set up for two-week sprints. It was interesting to finally be
      in a professsional environment, and I'm grateful for the opportunity to
      ...
      also did many things on my own accord to take advantage of this
      opportunity, such as learning and networking.
    </p>
  ),
};
...
const hydrow = {
  ...
  body: (
    <p className="pb-8">
      ...
      time-consuming, especially for the non-technical teams. The internal
      website I was taking a part in developing was replacing the CLI. The
      process of developing these webpages was very independent and required a
      lot of self-management. I took part in the user story creation,
      ...
      managed my time well and developed the webpages timely. In fact, I was
      told by my supervisors that I completed the webpages faster than they
      ...
      company, specifically the Workout Experience team and Customer Service
      team. I was estatic to hear how the internal website I worked on helped
      other employees and how happy they were to use it and not the CLI anymore.
      <br />
      <br />I worked on the front-end of the internal website in TypeScript,
      React, Node.js, and Next.js. They had Next.js in their tech stack and
      showed how using it improved the performance of the website. Thus, I
      learned Next.js for the first 2 weeks of the co-op while refreshing myself
      with TypeScript and React.js. At Hydrow, they also taught me about
      responsive design. I used TailwindCSS and Material UI to implement
      responsive designs for the webpages I developed. A lot of the TypeScript
      and React.js I know now resulted from working with it and learning it
      during this co-op. Outside of technical knowledge, I learned a lot about
      the importance of collaboration in Software Development. I worked a lot
      with other employees from the back-end team and other teams outside of
      software, like the Experience team and Customer Support team. Hydrow gave
      me a valuable experience in collaboration, web development, and general
      company culture.
    </p>
  ),
};
...
const ra = {
  ...
  body: (
    <p className="pb-8">
      ...
      respect for others. This was all done while balancing classes, homework,
      and extracurriculars. Being an RA was tough, but very rewarding.
    </p>
  ),
};

export const bodies: Bodies[] = [optum, hydrow, ra];
